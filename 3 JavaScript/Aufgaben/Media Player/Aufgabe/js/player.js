...
class Player {
    ...
    play(index) {
        ...
        // Wiedergabe starten
        this.audio.pause();
        //// TODO: Wiedergabe starten (müssen Sie googeln)
    }
    ...
    showSongTitle() {
        if (this.playlist[this.currentSong]) {
            this.view.currentSong = this.currentSong;
            //// TODO: Künstler und Songtitel des aktuellen Songs in der Kopfzeile anzeigen
        } else {
            this.view.currentSong = -1;
            //// TODO: "Wiedergabeliste ist leer" in der Kopfzeile anzeigen
        }
    }
    /**
    ...
    showPlayerStatus() {
        if (this.audio.paused) {
            ...
            //// TODO: Aktuelle Wiedergabezeit im Kasten links anzeigen, z.B. "2:42"
        }
    }
